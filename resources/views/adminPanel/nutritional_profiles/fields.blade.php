...
<div class="tab-content mt-5" id="myTabContent">
    ...
    <div class="tab-pane fade {{ $locale == 'en' ? 'show active' : ''}}" id="{{$name}}" role="tabpanel" aria-labelledby="{{$name}}-tab">
        ...
        <div class="form-group col-sm-6">
            ...
            {!! Form::text($locale . '[name]', isset($nutritionalProfile)? $nutritionalProfile->translate($locale)->name : '' , ['class' => 'form-control', 'placeholder' => $name . ' name']) !!}
        </div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{{ route('adminPanel.nutritionalProfiles.index') }}" class="btn btn-default">@lang('crud.cancel')</a>
</div>
