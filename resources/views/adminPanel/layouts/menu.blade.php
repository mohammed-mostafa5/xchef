...
<li class="menu-item  menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
    ...
    <div class="menu-submenu "><i class="menu-arrow"></i>
        <ul class="menu-subnav">
            ...
            <li class="menu-item  {{ Request::is('*adminPanel/mealCreators*') ? 'menu-item-active' : '' }}" aria-haspopup="true" >
                <a href="{{ route('adminPanel.mealCreators.index') }}" class="menu-link ">
                    <span class="svg-icon menu-icon">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <span class="menu-text">@lang('models/mealCreators.plural')</span>
                </a>
            </li>
            @endcan
...
<li class="menu-item  {{ Request::is('adminPanel/nutritionalProfiles*') ? 'menu-item-active' : '' }}" aria-haspopup="true" >
    <a href="{{ route('adminPanel.nutritionalProfiles.index') }}" class="menu-link ">
        ...
        <span class="menu-text">@lang('models/nutritionalProfiles.plural')</span>
    </a>
</li>
...
<li class="menu-item  {{ Request::is('adminPanel/cuisines*') ? 'menu-item-active' : '' }}" aria-haspopup="true" >
    <a href="{{ route('adminPanel.cuisines.index') }}" class="menu-link ">
        ...
        <span class="menu-text">@lang('models/cuisines.plural')</span>
    </a>
</li>
